...
const target = props.isBlank ? '_blank' : '_self'
</script>

<template>

  <a
      :href="props.url" :target="target"
      class="inline-flex justify-center items-center py-2 px-6  text-base font-mexium text-center text-white rounded-lg bg-red-500  hover:bg-red-600 focus:ring-4 focus:ring-red-300 dark:focus:ring-blue-900">
    {{ props.text }}
    <svg v-if="props.showArrow" class="w-3.5 h-3.5 ms-2 rtl:rotate-180" aria-hidden="true"
