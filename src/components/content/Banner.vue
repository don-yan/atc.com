...
<template>
  ...
  <div class="bg-gray-900 text-gray-100 p-4 flex justify-between lg:justify-center items-center flex-wrap space-y-2 mb-4" v-if="isOpen">
    <div class="font-bold mr-20">👒🔥 Hat Deals!</div>
    <div class="font-bold mr-20">👒🔥 Hat Deals!</div>
